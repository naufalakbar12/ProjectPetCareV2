    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <a href="<?= base_url('admin/makanan/tambah/') ?>" class="btn btn-sm btn-outline-warning">Tambah Makanan</a>
                </div>
            </div>
            <div class="row">
            <div class="col"></div>
            <div class="col-4">
        <form action = "<?= base_url('admin/makanan') ?>" method="get">
            ...
            <table class="table table-hover ">
                ...
                <tbody>
                    <?php foreach ($makanan_hewan as $item) : ?>
                        <tr>
                            ...
                            <td class="d-flex">
                                <div>
                                    <a href="<?= base_url('admin/makanan/edit/' . $item['id']) ?>" class="btn btn-sm btn-secondary">Edit</a>
                                </div>
